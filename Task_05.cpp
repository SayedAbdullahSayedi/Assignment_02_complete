...
int main() {
    ...
    cout << "The Whole Summary of Products: " << endl;
    ...
    int Customer_Loyalty_Points = (Last_Total > 300) ? 50 : 20;

    cout << "Dear customer your loyalty points are equal to: " << Customer_Loyalty_Points << endl;
