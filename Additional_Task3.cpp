...
int main() {
    ...
    std::cin >> Coupoun_Code;

    double Coupons_Discount = (Coupoun_Code == " Save 10% ") ? 10.0 : 0.0;
    
    double Total_After_Coupon = Final_Amount - Coupons_Discount;
    ...
    std::cout << "Your total after customer discount: " << Final_Amount << " $" << std::endl;
     ...
     std::cout << "Discount Coupon is: " << Coupons_Discount << " $" << std::endl;

    std::cout << "The total after applying for your coupon is: " << Total_After_Coupon << " $" << std::endl;
