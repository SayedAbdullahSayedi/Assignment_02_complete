...
int main() {
    ...
    if (Quantity_A > stockA) {
        std::cout << "Really sorry, We have only " << stockA << " units of Product (A) are available in stock." << std::endl;
        Quantity_A = stockA;
    }
    ...
    if (Quantity_B > stockB) {
        std::cout << "Really Sorry, we have only " << stockB << " units of Product (B) are available in stock." << std::endl;
        Quantity_B = stockB;
    }
    ...
    std::cin >> Quantity_C;
     ...
     if (Quantity_C > stockC) {
        std::cout << "Really Sorry, we have only " << stockC << " units of Product (C) are available in stock." << std::endl;
        Quantity_C = stockC;
    }
